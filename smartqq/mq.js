    ...
    var J = {
        ...
        each: function(arr, callback) {
            ...
            if (arr.length) {
                ...
                for (var i in arr) {
                    if (arr.hasOwnProperty(i)) if (callback.call(arr[i], arr[i], i, arr) === false) return;
                }
            }
        },
        map: function(arr, callback) {
            ...
            if (arr.length) {
                ...
                for (var i in arr) {
                    if (arr.hasOwnProperty(i)) arr[i] = callback.call(arr[i], arr[i], i, arr);
                }
            }
        },
...
//browser
J.$package(function(J) {
    var s, browser, ua = navigator.userAgent.toLowerCase(),
        ...
        className: function(className, context) {
            ...
            if (context.getElementsByClassName) {
                ...
                for (i = 0, l = children.length; i < l; ++i) {
                    if (classNames = children[i].className && J.indexOf(classNames.split(' '), className) >= 0) {
...
J.$package(function(J) {
    ...
    var support = {
        fixed: (function() {
            ...
            if (originalHeight) $D.setStyle(container, "height", originalHeight + "px");
            else $D.setStyle(container, "height", "");
        ...
        transitionend: (function() {
            ...
            // 模拟transition，异步得出检测结果
                ...
                endEventNames = ['transitionend', 'webkitTransitionEnd', 'MozTransitionEnd', 'MSTransitionEnd', 'otransitionend', 'oTransitionEnd'];
...
J.$package(function(J) {
    ...
    var transitionEndNames = ['transitionend', 'webkitTransitionEnd', 'MozTransitionEnd', 'MSTransitionEnd'];
...
J.$package(function(J) {
    ...
    var Animation = J.Class({
        ...
        translate: function(translateX, translateY, translateZ) {
            if (support3d && translateZ) this.transformArr.push("translate3d" + '(' + translateX + ',' + translateY + ',' + translateZ + ')');
            else this.transformArr.push("translate" + '(' + translateX + ',' + translateY + ')');
            return this;
        },
...
"./error", "jm"], function() {
    J.$package("mq", function(J) {
        ...
        this.monitor = function(n) {
            ...
            var t = "//report.url.cn/report/report_vm?monitors=[" + n.join(",") + "]&t=" + new Date,
            i = new Image;
            i.src = t
        };
        ...
        var Tab = new J.Class({
            ...
            select: function(idOrIndex, noEvent, force) {
                ...
                if (this._selectedIndex !== -1 && (current = this._arr[this._selectedIndex])) {
                    current.trigger && $D.removeClass(current.trigger, this._selectedClass);
                    current.sheet && $D.removeClass(current.sheet, this._selectedClass);
                }
                if (this._selectedIndex === obj.index) {
                    ...
                    target.trigger && $D.addClass(target.trigger, this._selectedClass);
                    target.sheet && $D.addClass(target.sheet, this._selectedClass);
                }
                if (!noEvent) {
    ...
    JM.$package("MUI", function(J) {
        ...
        var Slide = J.Class({
            ...
            slideTo: function(index) {
                ...
                setTimeout(function() {
                    if (isWebkit) self.contentWrap.style["-webkit-transition"] = "all " + self.slideTime / 1000 + "s " + self.runType;
...
define('mq.i18n', ["jm"], function() {
    J.$package("mq.i18n", function(J) {
        ...
        var faceTextArr = [
            ["微笑", "撇嘴", "色", "发呆", "得意", "流泪", "害羞", "闭嘴", "睡", "大哭", "尴尬", "发怒", "调皮", "呲牙", "惊讶", "难过", "酷", "冷汗", "抓狂", "吐", "偷笑", "可爱", "白眼", "傲慢", "饥饿", "困", "惊恐", "流汗", "憨笑", "大兵", "奋斗", "咒骂", "疑问", "嘘", "晕", "折磨", "衰", "骷髅", "敲打", "再见", "擦汗", "抠鼻", "鼓掌", "糗大了", "坏笑", "左哼哼", "右哼哼", "哈欠", "鄙视", "委屈", "快哭了", "阴险", "亲亲", "吓", "可怜", "菜刀", "西瓜", "啤酒", "篮球", "乒乓", "咖啡", "饭", "猪头", "玫瑰", "凋谢", "示爱", "爱心", "心碎", "蛋糕", "闪电", "炸弹", "刀", "足球", "瓢虫", "便便", "月亮", "太阳", "礼物", "拥抱", "强", "弱", "握手", "胜利", "抱拳", "勾引", "拳头", "差劲", "爱你", "NO", "OK", "爱情", "飞吻", "跳跳", "发抖", "怄火", "转圈", "磕头", "回头", "跳绳", "挥手", "激动", "街舞", "献吻", "左太极", "右太极", "双喜", "鞭炮", "灯笼", "发财", "K歌", "购物", "邮件", "帅", "喝彩", "祈祷", "爆筋", "棒棒糖", "喝奶", "下面", "香蕉", "飞机", "开车", "左车头", "车厢", "右车头", "多云", "下雨", "钞票", "熊猫", "灯泡", "风车", "闹钟", "打伞", "彩球", "钻戒", "沙发", "纸巾", "药", "手枪", "青蛙"],
...
define('mq.util', ["jm"], function() {
    J.$package("mq.util", function(J) {
        ...
        this.report2BNL = function(param) {
            ...
            var url = REPORT_CGI + '?strValue=' + s + '&tag=0' + '&qver=' + mq.getVersion();
        ...
        this.report2BNL2 = function(id, obj) {
            obj = obj || 0;
            var url = REPORT_CGI + '?strValue=' + obj + '&nValue=' + id + '&tag=0' + '&qver=' + mq.getVersion();
            qtracker.tracker.Img.send(url);
        }
    ...
    J.$package("mq.util", function() {
        ...
        function insert(element) {
            baseElement ? head.insertBefore(element, baseElement) : head.appendChild(element);
        }
...
define('tmpl!../tmpl/tmpl_title_panel.html', [], function() {
    return function(obj) {
        ...
        with(obj || {}) {
            __p += '';
            if (hasHeader) {
                __p += '\r\n<header id="panelHeader-' + ((__t = (id)) == null ? '' : __t) + '" class="panel_header">\r\n    ';
                if (leftButton) {
                    __p += '\r\n    <div id="panelLeftButton-' + ((__t = (id)) == null ? '' : __t) + '" class="btn btn_small btn_left btn_black ' + ((__t = (leftButton.className)) == null ? '' : __t) + '" cmd="clickLeftButton">\r\n        <span id="panelLeftButtonText-' + ((__t = (id)) == null ? '' : __t) + '" class="' + ((__t = ( !! leftButton.text ? 'btn_text' : 'btn_img')) == null ? '' : __t) + '">' + ((__t = (encode(leftButton.text))) == null ? '' : __t) + '</span>\r\n    </div>\r\n    ';
                }
                __p += '\r\n        <h1 id="panelTitle-' + ((__t = (id)) == null ? '' : __t) + '" class="text_ellipsis padding_20">' + ((__t = (encode(title))) == null ? '' : __t) + '</h1>\r\n    ';
                if (rightButton) {
                    __p += '\r\n    <button id="panelRightButton-' + ((__t = (id)) == null ? '' : __t) + '" class="btn btn_small btn_right btn_black ' + ((__t = (rightButton.className)) == null ? '' : __t) + '" cmd="clickRightButton">\r\n        <span id="panelRightButtonText-' + ((__t = (id)) == null ? '' : __t) + '" class="' + ((__t = ( !! rightButton.text ? 'btn_text' : 'btn_img')) == null ? '' : __t) + '">' + ((__t = (encode(rightButton.text))) == null ? '' : __t) + '</span>\r\n    </button>\r\n    ';
                }
                __p += '\r\n</header>\r\n';
            }
            __p += '\r\n<div id="panelBodyWrapper-' + ((__t = (id)) == null ? '' : __t) + '" class="panel_body_container" style="' + ((__t = (hasHeader ? 'top: 45px;' : '')) == null ? '' : __t) + ' ' + ((__t = (hasFooter ? 'bottom: 50px;' : '')) == null ? '' : __t) + '">\r\n    <div id="panelBody-' + ((__t = (id)) == null ? '' : __t) + '" class="panel_body ' + ((__t = (body.className)) == null ? '' : __t) + '">' + ((__t = (body.html)) == null ? '' : __t) + '</div>\r\n    <ul id="pannelMenuList-' + ((__t = (id)) == null ? '' : __t) + '" class="pannel_menu_list">\r\n    </ul>\r\n</div>\r\n';
            if (hasFooter) {
                __p += '\r\n<footer id="panelFooter-' + ((__t = (id)) == null ? '' : __t) + '" class="' + ((__t = (footer.className || '')) == null ? '' : __t) + '" >\r\n    ' + ((__t = (footer.html)) == null ? '' : __t) + '\r\n</footer>\r\n';
            }
            __p += '\r\n';
        }
        return __p;
    ...
    return function(obj) {
        ...
        with(obj || {}) {
            ...
            for (var i = 0, item; item = menuItems[i]; i++) {
                __p += '\r\n<li cmd="' + ((__t = (item.cmd)) == null ? '' : __t) + '" class="' + ((__t = (item.cmd)) == null ? '' : __t) + '">\r\n    <div class="menu_list_icon"></div>\r\n    ' + ((__t = (item.text)) == null ? '' : __t) + '\r\n</li>\r\n';
            }
            __p += '';
        }
        return __p;
...
define('mq.view.TitlePanel', ['tmpl!../tmpl/tmpl_title_panel.html', 'tmpl!../tmpl/tmpl_main_menu.html', "./mq.i18n", "./mq.view.transitionmanager"], function(tmplTitlePanel, tmplMainMenu) {
...
define('mq.rpcservice', ["./mq.portal", "./mq.report"], function() {
    ...
    J.$package("mq.rpcService", function(J) {
        ...
        var PROXY_URLS = {
            "s.web2.qq.com": "//s.web2.qq.com/proxy.html?v=20130916001",
            // 有一部分cgi使用域名
         ...
         */
        {
            ...
            init: function(id, proxyUrl) {
                ...
                /* && isFirstRequest*/
                ) { //firefox有iframe的内存泄漏bug, 这里采用放弃第一次请求的方法
        ...
        this.require = function(option) {
            ...
            option.onSuccess = option.onSuccess ||
            function(data) {
                var code = ('retcode' in data) ? data.retcode : ('ret' in data ? data.ret : -1);
        ...
        this.sendPoll = function() {
            ...
            this.require({
                url: SEND_POLL_CGI,
                https: false,
                // mq.setting.enableHttps, 强制https
                action: 'poll',
                method: 'POST',
                data: data,
                timeout: 120000,
                //long poll 120s timeout
    ...
    J.$package("mq.view", function(J) {
        ...
        this.MemberList = J.Class({
            ...
            render: function(data, notRefresh) {
                ...
                this.listContainer.innerHTML = html; ! notRefresh && this.refresh();
            },
            ...
            renderAllOnlineStateCount: function(categories) {
                ...
                J.each(categories, function(c, i) {
                    o = op[i];
                    if (o) o.innerHTML = (c.count - c.list.offline.length) + "/" + c.count;
                });
            },
            append: function(data, notRefresh) {
                ...
                this.listContainer.appendChild(fragment); ! notRefresh && this.refresh();
            },
            destory: function() {
                for (var i in this) {
                    if (this.hasOwnProperty(i)) {
...
define('mq.model.memberlist', ["./mq.i18n", "./mq.portal", "./mq.report"], function() {
    ...
    J.$package("mq.model.buddylist", function(J) {
        ...
        var hash2 = function(uin, ptvfwebqq) {
            ...
            var result = [];
            for (var i = 0; i < 8; i++) {
                if (i % 2 == 0) result[i] = ptb[i >> 1];
                else result[i] = uinByte[i >> 1];
            }
...
define('mq.model.chat', ["./mq.portal"], function() {
    ...
    J.$package("mq.model.chat", function(J) {
        ...
        this.receiveMessage = function(msg) {
            var from_uin = msg.from_uin,
            from_user, to_uin = msg.to_uin,
            to_user, selfUin = this.m_model.getSelfUin();
        ...
        this.receiveFile = function(msg) {
            ...
            if (msg.mode === 'recv') {
                ...
                */
                ...
                var _tmp = parseInt(msg.session_id, 10).toString(2);
                if (_tmp.length < 12) return false;
                _tmp = _tmp.substr(_tmp.length - 12, 12);
                msg.session_id = parseInt(_tmp, 2).toString(10);
        ...
        with(obj || {}) {
            ...
            for (var i = 0, item; item = list[i]; i++) {
                ...
                if (lastMessage && isNearTime(lastMessage.time, item.time)) {
                    ...
                    __p += '\r\n<div class="chat_time"><span>' + ((__t = (formatChatTime(item.time))) == null ? '' : __t) + '</span></div>\r\n    ';
                }
                ...
                if (!item.system) {
                    ...
                    if (item.from_group && sender && sender.cardName) {
                        ...
                        __p += '\r\n        <p class="chat_nick">' + ((__t = (html((sender ? sender.name : item.sender_uin) + ''))) == null ? '' : __t) + '</p>\r\n    ';
                    }
                    __p += '\r\n    ';
                }
                __p += '\r\n    <p class="chat_content ">' + ((__t = (translate(item.htmlContent))) == null ? '' : __t) + '</p>\r\n</div>\r\n\r\n';
            }
            __p += '\r\n';
        }
        return __p;
...
define('tmpl!../tmpl/tmpl_chat_tools.html', [], function() {
    return function(obj) {
        ...
        with(obj || {}) {
            __p += '\r\n<iframe id="panel_uploadFilIframe_' + ((__t = (friendUin)) == null ? '' : __t) + '" name="panel_uploadFilIframe_' + ((__t = (friendUin)) == null ? '' : __t) + '" style="display:none" src="http://web2.qq.com/domain.html"></iframe>\r\n<form id="panel_uploadFile_' + ((__t = (friendUin)) == null ? '' : __t) + '" name="panel_uploadFile_' + ((__t = (friendUin)) == null ? '' : __t) + '"  title="发送文件..." class="panelSendForm" target="panel_uploadFilIframe_' + ((__t = (friendUin)) == null ? '' : __t) + '" action="" method="POST" enctype="multipart/form-data">\r\n   <a href="javascript:void(0)" id="panel_fileButton_' + ((__t = (friendUin)) == null ? '' : __t) + '" hidefocus="true" class="simpleMenuItem panel_sendFileButton" title="发送文件...">\r\n        <input id="upload_file_' + ((__t = (friendUin)) == null ? '' : __t) + '" class="f" name="file" type="file" >\r\n   </a>\r\n</form>';
        }
        return __p;
    };
});
...
define('tmpl!../tmpl/tmpl_chat_sendfile.html', [], function() {
    return function(obj) {
        ...
        with(obj || {}) {
            __p += '<form id="panel_uploadFile_' + ((__t = (id)) == null ? '' : __t) + '" name="panel_uploadFile" title="' + ((__t = (title)) == null ? '' : __t) + '" class="panelSendForm" target="panel_uploadFilIframe" action="" method="POST" enctype="multipart/form-data">\r\n    <a href="#" hidefocus="true" class="panel_sendFileButton" title="' + ((__t = (title)) == null ? '' : __t) + '">\r\n        <input id="upload_file_' + ((__t = (id)) == null ? '' : __t) + '" class="file_input" name="file" type="file">\r\n    </a>\r\n</form>';
        }
        return __p;
    };
});

define('mq.view.chat', ['tmpl!../tmpl/tmpl_chat_footer.html', 'tmpl!../tmpl/tmpl_chat_list.html', 'tmpl!../tmpl/tmpl_chat_tools.html', 'tmpl!../tmpl/tmpl_chat_sendfile.html', "./mq.i18n", "./mq.view.transitionmanager"
    ...
    J.$package("mq.view.chat", function(J) {
        ...
        var tempFlag = false,
        chatTextarea, sendFileForm, sendFileInput, face_images, sc;
        ...
        var formatChatTime = function(time) {
            ...
            if (time.getFullYear() === current.getFullYear() && time.getMonth() === current.getMonth() && time.getDate() === current.getDate()) {
        ...
        this.uploadSendFile = function(e) {
            ...
            sendFileForm.action = mq.FILE_SERVER + 'v2/' + mq.model.buddylist.getSelfUin() + '/' + currentChatUser.account + '/' + samp + '/' + mq.index + '/' + mq.port + '/1/f/1/0/0?psessionid=' + mq.psessionid;
        ...
        this.receiveFile = function(attach) {
            var fileUrl = mq.DYNAMIC_CGI_URL + 'channel/get_file2?lcid=' + attach.session_id + '&guid=' + attach.name + '&to=' + attach.from_uin + '&psessionid=' + mq.psessionid + '&count=1&time=' + (+new Date) + '&clientid=' + mq.clientid;
        ...
        this.receiveOfflineFile = function(attach) {
            var fileUrl = 'https://' + attach.ip + ':' + attach.port + '/' + attach.name + '?ver=2173&rkey=' + attach.rkey + '&range=0';
...
define('mq.presenter.chat', ['./mq.i18n'], function() {
    ...
    J.$package("mq.presenter.chat", function(J) {
        ...
        var currentChatUin;
        //当前聊天对象类型
        var currentChatType, selfUin, faceTextMatchID;
        var contentTextArr = [],
        isFaceTextArr = [];
            ...
            for (var j = 0, c; c = content[j]; j++) {
                if (J.type.isArray(c)) {
                    ...
                    case 'offpic':
                        ...
                        break;
                    case 'sendfile':
                        htmlContent.push('<span class="icon icon_info"></span>您发送文件"' + $S.encodeHtml(c[1]) + '"给对方。');
                        break;
                    case 'transtimeout':
                        htmlContent.push('<span class="icon icon_err"></span>接收文件"' + $S.encodeHtml(c[1]) + '"超时，文件传输失败。');
                        break;
                    case 'refusedbyclient':
                        htmlContent.push('<span class="icon icon_err"></span>对方取消了接收文件"' + $S.encodeHtml(c[1]) + '"，文件传输失败。');
                        break;
                    case 'transok':
                        htmlContent.push('<span class="icon icon_succ"></span>文件"' + $S.encodeHtml(c[1]) + '"传输成功。');
                        break;
                    case 'transerror':
                        htmlContent.push('<span class="icon icon_err"></span>对方取消了接收文件"' + $S.encodeHtml(c[1]) + '"或传输错误，文件传输失败。');
                        break;
                    case 'rffile':
                        if (isSelf) {
                            htmlContent.push('<span class="icon icon_err"></span>您拒绝接收"' + $S.encodeHtml(c[1]) + '"，文件传输失败。');
                        } else {
                            htmlContent.push('<span class="icon icon_err"></span>对方取消了接收文件"' + $S.encodeHtml(c[1]) + '"，文件传输失败。');
                        }
                        ...
                        break;
                    case 'agfile':
                        htmlContent.push('<span class="icon icon_info"></span>您同意了接收文件"' + $S.encodeHtml(c[1]) + '"。');
                        break;
                    case 'rtfile':
                        htmlContent.push('<span class="icon icon_err"></span>接收文件"' + $S.encodeHtml(c[1]) + '"超时，文件传输失败。');
                        break;
                    case 'wrfile':
                        htmlContent.push('<span class="icon icon_info"></span>对方已同意接收"' + $S.encodeHtml(c[1]) + '"，开始传输文件。');
                        break;
                    case 'wrffile':
                        htmlContent.push('<span class="icon icon_err"></span>对方拒绝了接收文件"' + $S.encodeHtml(c[1]) + '"，文件传输失败。');
                        break;
                    case 'rfile':
            ...
            for (i = 0; c = content[i]; ++i) {
                if (J.type.isArray(c)) {
                    ...
                    case 'font':
                        break;
                    case 'face':
                        textContent.push("[" + $F(FACE_WEBQQ_MAP.indexOf(c[1])) + "]");
                        break;
                    case 'cface':
                    case 'offpic':
        ...
        var getReceiveFileHtml = function(msg) {
            ...
            html = '<span class="icon icon_info" ></span>对方给您发送文件: <br/>' + '<span class="file_icon icon_' + getFileTypeStyle(c[1]) + '">&nbsp;</span>' + $S.encodeHtml(c[1]) + '<span class="fileAct">';

            if (filesList[fileid].isread) {
                html += '&nbsp;[同意][拒绝]';
            } else {
                html += '&nbsp;<span class="fileLink" id="agree_' + fileid + '" _fileid="' + fileid + '" cmd="agreeFile" >' + '[同意]</span>';
                html += '&nbsp;<span class="fileLink" id="refuse_' + fileid + '" _fileid="' + fileid + '" cmd="refuseFile">' + '[拒绝]</span>';
            }
            html += '</span>';
            return html;
        }
        ...
        var getReceiveOfflineFileHtml = function(msg) {
            ...
            html += '<span class="file_icon icon_' + getFileTypeStyle(msg.attach.name) + '">&nbsp;</span>' + $S.encodeHtml(msg.attach.name) + '(' + exTime + '到期)' + '<span class="fileAct">';

            html += '&nbsp;<span class="fileLink" id="agree_' + fileid + '" _fileid="' + fileid + '" cmd="agreeOfflineFile">' + '[接收]</span>';
            html += '&nbsp;<span class="fileLink" id="next_' + fileid + '" _fileid="' + fileid + '" cmd="nextOfflineFile">' + '[下次接收]</span>';
            html += '&nbsp;<span class="fileLink" id="refuse_' + fileid + '" _fileid="' + fileid + '" cmd="refuseOfflineFile" >' + '[拒绝]</span>'
            html += '</span>';
    ...
    return function(obj) {
        ...
        with(obj || {}) {
            ...
            if (type === 'category') {
                __p += '\r\n';
                for (i = 0; item = list[i]; i++) {
                    __p += '\r\n<li class="list_group">\r\n    <div id="groupTitle-' + ((__t = (item.index)) == null ? '' : __t) + '" class="list_group_title list_group_white_title list_arrow_right" cmd="clickMemberGroup" param="' + ((__t = (item.index)) == null ? '' : __t) + '">\r\n        <span>' + ((__t = (html(item.name))) == null ? '' : __t) + '</span>\r\n        <span class="onlinePercent"></span>\r\n    </div>\r\n    <ul id="groupBodyUl-' + ((__t = (item.index)) == null ? '' : __t) + '" class="list_group_body list list_white catogory_List"></ul>\r\n</li>\r\n';
                }
                __p += '\r\n';
            } else if (type === 'list') {
                ...
                for (i = 0; item = list[i]; i++) {
                    ...
                    __p += '\r\n    </a>\r\n    <p class="member_nick" id="userNick-' + ((__t = (item.account)) == null ? '' : __t) + '">\r\n    ';
                    if (item.mark) {
                        __p += '\r\n        ' + ((__t = (html(item.mark))) == null ? '' : __t) + '<span>(' + ((__t = (html(item.name))) == null ? '' : __t) + ')</span>\r\n    ';
                    } else if (item.cardName) {
                        __p += '\r\n        ' + ((__t = (html(item.cardName))) == null ? '' : __t) + ' <span> (' + ((__t = (html(item.name))) == null ? '' : __t) + ')</span>\r\n    ';
                    } else {
                        __p += '\r\n        ' + ((__t = (html(item.name))) == null ? '' : __t) + '\r\n    ';
                    }
                    __p += '\r\n    </p>\r\n    ';
                    if (typeof dataType != 'undefined' && dataType === 'recent') {
                        __p += '\r\n    <p id="recent-item-' + ((__t = (item.type)) == null ? '' : __t) + '-' + ((__t = (item.account)) == null ? '' : __t) + '-msg" class="member_msg text_ellipsis">' + ((__t = (item.recentMessage || '')) == null ? '' : __t) + '</p>\t\r\n    ';
                    } else if (typeof dataType == 'undefined' || dataType != 'search') {
                        __p += '\r\n    <p class="member_msg text_ellipsis" >\r\n    ';
                        if (item.stateName) {
                            __p += '\r\n    <span class="member_state">' + ((__t = (item.stateName)) == null ? '' : __t) + '</span>\r\n    ';
                        }
                        __p += '\r\n    ';
                        if (item.signature) {
                            __p += '\r\n    <span class="member_signature" _signature_load="1">' + ((__t = (html(item.signature))) == null ? '' : __t) + '</span>\r\n    ';
                        }
                        __p += '\t\r\n    </p>\r\n    ';
                    }
                    __p += '\t\r\n\r\n    </li>\r\n    ';
...
define('mq.view.search', ['tmpl!../tmpl/tmpl_search_body.html', 'tmpl!../tmpl/tmpl_member_list.html', "./mq.i18n", "./mq.view.transitionmanager"], function(tmplSearchBody, tmplMemberList) {
...
define('mq.presenter.profile', ["./mq.i18n", "./mq.view.transitionmanager"], function() {
    J.$package("mq.presenter.profile", function(J) {
        ...
        var handlers = {
            ...
            onBuddyInfoUpdate: function(info) {
                if (currentProfile && currentProfile.type === info.type && currentProfile.account === info.account) {
                    currentProfile = info;
...
define('tmpl!../tmpl/tmpl_profile_body.html', [], function() {
    return function(obj) {
        ...
        with(obj || {}) {
            __p += '\r\n<div class="group">\r\n    <div class="row clearfix">\r\n        <div class="cloumn">\r\n            <img class="avatar" src="' + ((__t = (profile.avatar)) == null ? '' : __t) + '">\r\n        </div>\r\n        <div class="cloumn profile_title">\r\n            <div class="row profile_name">' + ((__t = (encode(profile.name))) == null ? '' : __t) + '</div>\r\n            <div class="row profile_account">' + ((__t = (profile.ruin ? profile.ruin : "")) == null ? '' : __t) + '</div>\r\n        </div>\r\n        ';
            if (profile.type === 'friend') {
                __p += '\r\n        <button class="sendMsg2Member" cmd="sendMsg2Member">' + ((__t = ($M('sendMsg'))) == null ? '' : __t) + '</button>\r\n        ';
            }
            __p += '\r\n    </div>\r\n</div>\r\n';
            if (profile.type === 'friend') {
                __p += '\r\n    ';
                if (profile.signature) {
                    __p += '\r\n<div class="group">\r\n    <div class="row profile_signature">\r\n        <span class="label">' + ((__t = ($M('signature'))) == null ? '' : __t) + '</span><p class="row-content">' + ((__t = (encode(profile.signature))) == null ? '' : __t) + '</p>\r\n    </div>\r\n</div>\r\n    ';
                }
                __p += '\r\n<div class="group">\r\n    ';
                if (profile.gender) {
                    __p += '\r\n    <div class="row ">\r\n        <span class="label">' + ((__t = ($M('gender'))) == null ? '' : __t) + '</span>';

                    if (profile.gender === 'male') {

                        __p += '' + ((__t = ($M('male'))) == null ? '' : __t) + '';

                    } else if (profile.gender === 'female') {

                        __p += '' + ((__t = ($M('female'))) == null ? '' : __t) + '';

                    } else {

                        __p += '' + ((__t = ($M('unknown'))) == null ? '' : __t) + '';
                ...
                if (profile.birthday) {
                    ...
                    __p += '\r\n    <div class="row ">\r\n        <span class="label">' + ((__t = ($M('birthday'))) == null ? '' : __t) + '</span>' + ((__t = (b.year + '/' + b.month + '/' + b.day)) == null ? '' : __t) + '\r\n    </div>\r\n    ';
                }
                __p += '\r\n</div>\r\n<div class="group">\r\n    ';
                if (profile.country) {
                    __p += '\r\n    <div class="row ">\r\n        <span class="label">' + ((__t = ($M('country'))) == null ? '' : __t) + '</span>' + ((__t = (encode(profile.country))) == null ? '' : __t) + '\r\n    </div>\r\n    ';
                }
                __p += '\r\n    ';
                if (profile.province) {
                    __p += '\r\n    <div class="row ">\r\n        <span class="label">' + ((__t = ($M('province'))) == null ? '' : __t) + '</span>' + ((__t = (encode(profile.province))) == null ? '' : __t) + '\r\n    </div>\r\n    ';
                }
                __p += '\r\n    ';
                if (profile.city) {
                    __p += '\r\n    <div class="row ">\r\n        <span class="label">' + ((__t = ($M('city'))) == null ? '' : __t) + '</span>' + ((__t = (encode(profile.city))) == null ? '' : __t) + '\r\n    </div>\r\n    ';
                }
                __p += '\r\n</div>\r\n<div class="group">\r\n    ';
                if (profile.phone) {
                    __p += '\r\n    <div class="row ">\r\n        <span class="label">' + ((__t = ($M('phone'))) == null ? '' : __t) + '</span>' + ((__t = (encode(profile.phone + ''))) == null ? '' : __t) + '\r\n    </div>\r\n    ';
                }
                __p += '\r\n    ';
                if (profile.mobile) {
                    __p += '\r\n    <div class="row ">\r\n        <span class="label">' + ((__t = ($M('mobile'))) == null ? '' : __t) + '</span>' + ((__t = (encode(profile.mobile + ''))) == null ? '' : __t) + '\r\n    </div>\r\n    ';
                }
                __p += '\r\n    ';
                if (profile.email) {
                    __p += '\r\n    <div class="row ">\r\n        <span class="label">' + ((__t = ($M('email'))) == null ? '' : __t) + '</span>' + ((__t = (encode(profile.email))) == null ? '' : __t) + '\r\n    </div>\r\n    ';
                }
                __p += '\r\n</div>\r\n';
            }
            /********************* end of friend *************************/
            ...
            if (profile.type === 'group') {
                __p += '\r\n';
                if (profile.memo) {
                    __p += '\r\n<div class="group">\r\n    <div class="row ">\r\n        <span class="label">' + ((__t = ($M('publish'))) == null ? '' : __t) + '</span><p class="row-content">' + ((__t = (encode(profile.memo))) == null ? '' : __t) + '</p>\r\n    </div>\r\n</div>\r\n';
                }
                __p += '\r\n<div class="group clickable">\r\n    <div class="row clearfix" cmd="viewGroupMember">\r\n        <span class="label">' + ((__t = ($M('group_member'))) == null ? '' : __t) + '</span><span class="more_icon"></span><span class="text_right">' + ((__t = (profile.members.length + $M('buddy_unit'))) == null ? '' : __t) + '</span>\r\n    </div>\r\n</div>\r\n';
            }
            /********************* end of group *************************/
            __p += '\r\n';
            if (profile.type === 'discuss') {
                __p += '\r\n<div class="group clickable">\r\n    <div class="row clearfix" cmd="viewDiscussMember">\r\n        <span class="label">' + ((__t = ($M('discuss_member'))) == null ? '' : __t) + '</span><span class="more_icon"></span><span class="text_right">' + ((__t = (profile.members.length + $M('buddy_unit'))) == null ? '' : __t) + '</span>\r\n    </div>\r\n</div>\r\n';
            }
            /********************* end of discuss *************************/
            __p += '\r\n';
        }
...
define('mq.view.profile', ['tmpl!../tmpl/tmpl_profile_body.html', "./mq.i18n", "./mq.view.transitionmanager"], function(tmplProfileBody) {
...
define('mq.view.record', ['tmpl!../tmpl/tmpl_record_footer.html', "./mq.i18n", "./mq.view.transitionmanager"], function(tmplRecordFooter) {
...
define('mq.view.session', ['tmpl!../tmpl/tmpl_session_body.html', 'tmpl!../tmpl/tmpl_member_list.html', "./mq.i18n", "./mq.view.transitionmanager"], function(tmplSessionBody, tmplMemberList) {
...
define('tmpl!../tmpl/tmpl_setting_body.html', [], function() {
    return function(obj) {
        ...
        with(obj || {}) {
            __p += '<div class="group">\r\n    <div class="row clearfix">\r\n        <div class="cloumn">\r\n            <img class="avatar" src="' + ((__t = (user.avatar)) == null ? '' : __t) + '">\r\n        </div>\r\n        <div class="cloumn profile_title_setting">\r\n            <div class="text_ellipsis profile_name row">' + ((__t = (encode(user.nick))) == null ? '' : __t) + '</div>\r\n            <div class="row profile_account">' + ((__t = (user.account)) == null ? '' : __t) + '</div>\r\n        </div>\r\n        <div id="online_state_setting" class="online_state_setting">\r\n            <i id="main_icon" class="main_icon online_icon"></i><i class="down_arrow"></i>\r\n            <ul>\r\n                <li><i class="online_icon"></i>' + ((__t = ($M('online'))) == null ? '' : __t) + '</li>\r\n                <li><i class="callme_icon"></i>' + ((__t = ($M('callme'))) == null ? '' : __t) + '</li>\r\n                <li><i class="away_icon"></i>' + ((__t = ($M('away'))) == null ? '' : __t) + '</li>\r\n                <li><i class="busy_icon"></i>' + ((__t = ($M('busy'))) == null ? '' : __t) + '</li>\r\n                <li><i class="silent_icon"></i>' + ((__t = ($M('silent'))) == null ? '' : __t) + '</li>\r\n                <li><i class="hidden_icon"></i>' + ((__t = ($M('hidden'))) == null ? '' : __t) + '</li>\r\n                <li><i class="offline_icon"></i>' + ((__t = ($M('offline'))) == null ? '' : __t) + '</li>\r\n            </ul>\r\n\r\n        </div>\r\n    </div> \r\n</div> \r\n\r\n';
            if (user.lnick) {
                __p += '\r\n<div class="group">\r\n    <div class="row profile_signature">\r\n        <span class="label">' + ((__t = ($M('signature'))) == null ? '' : __t) + '</span>\r\n        <span>' + ((__t = (encode(user.lnick))) == null ? '' : __t) + '</span>\r\n    </div>\r\n    \r\n</div>\r\n';
            }
            __p += '  \r\n\r\n<div class="group clickAble" cmd="clickNotifySetting">\r\n    <div class="row ">\r\n        ' + ((__t = ($M('notify_setting'))) == null ? '' : __t) + '\r\n        <span class="more_icon"></span>\r\n    </div>\r\n</div>\r\n\r\n<div class="group clickAble" cmd="clickShowAbout">\r\n    <div class="row ">\r\n        ' + ((__t = ($M('about_qq'))) == null ? '' : __t) + '\r\n        <span class="more_icon"></span>\r\n    </div>\r\n</div>\r\n\r\n<div id="about_qq_all" class="group" style="display:none;">\r\n             <div class="row ">\r\n              <span class="label">' + ((__t = ($M('version'))) == null ? '' : __t) + '</span>\r\n              ' + ((__t = ($M('current_version'))) == null ? '' : __t) + '\r\n            </div>\r\n            <div class="row ">\r\n            ' + ((__t = ($M('service'))) == null ? '' : __t) + '\r\n            </div>\r\n            <div class="row " cmd="clickFeedBack">\r\n                ' + ((__t = ($M('help'))) == null ? '' : __t) + '\r\n                <span class="more_icon"></span>\r\n            </div>\r\n\r\n</div>\r\n\r\n<div class="group clickAble" cmd="clickLogout">\r\n    <div class="row loginout">    \r\n            ' + ((__t = ($M('loginout'))) == null ? '' : __t) + '          \r\n    </div>\r\n</div>\r\n';
        }
        return __p;
    };
});
                ...
                $E.on(this.elem, "click", function(e) {
                    ...
                    if (list = $D.closest(target, "ul")) {
                        ...
                        J.each(listItems, function(l, i) {
                            if (l == selectedItem) selectedIndex = i;
                        });
...
define('mq.view.setting', ['tmpl!../tmpl/tmpl_setting_body.html', "./mq.i18n", "./mq.view.transitionmanager", '../lib/mui/js/mui.select'], function(tmplSettingBody) {
...
define('tmpl!../tmpl/tmpl_plugin_body.html', [], function() {
    return function(obj) {
        ...
        with(obj || {}) {
            ...
            for (var i = 0, item; item = items[i]; ++i) {
                __p += '\r\n    <li id="' + ((__t = (item.id)) == null ? '' : __t) + '" cmd="clickItem">\r\n        <span class="icon"></span>\r\n        <a>' + ((__t = (item.text)) == null ? '' : __t) + '</a>\r\n    </li>\r\n    ';
            }
            __p += '\r\n</ul>';
        }
        return __p;
...
define('mq.view.plugin', ['tmpl!../tmpl/tmpl_plugin_body.html', 'jm', "./mq.i18n", "./mq.view.transitionmanager"], function(tmplPluginBody) {
...
define('mq.view.pluginDisplayer', ["./mq.i18n", "./mq.view.transitionmanager"], function() {
    J.$package("mq.view.pluginDisplayer", function(J) {
        ...
        tmplDisplayer = function(id, url) {
            var arr = ['<iframe id="', id, '" ', url ? 'src="' + url + '"' : '', '>'];
            return arr.join('');
        };
        ...
        this.startDisplayPlugin = function(plugin) {
            ...
            if (currentPlugin) {
                isDifferent = false;
                for (key in plugin) {
                    if (plugin.hasOwnProperty(key) && plugin[key] !== currentPlugin[key]) {
                        isDifferent = true;
                        break;
                    }
                }
            ...
            return function(mode) {
                if (!_container) {
                    ...
                    if (mode == AUDIO_MODE.FLASH) {
                        node.innerHTML = '<object id="jmAudioObject" name="jmAudioObject" ' + (J.browser.ie ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"' : 'type="application/x-shockwave-flash" data="' + AUDIO_OBJECT + '"') + ' width="1" height="1" align="top"><param name="movie" value="' + AUDIO_OBJECT + '" /><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="quality" value="high" /><param name="wmode" value="opaque" /></object>';
        ...
        case AUDIO_MODE.WMP:
            ...
            },
            {
                ...
                _hasPositionChange: function() {
                    return (this._handler['timeupdate'] && this._handler['timeupdate'].length) || (this._handler['seeked'] && this._handler['seeked'].length);
                },
                ...
                _hasOpenStateChange: function() {
                    return (this._handler['loadstart'] && this._handler['loadstart'].length) || (this._handler['loadeddata'] && this._handler['loadeddata'].length) || (this._handler['canplay'] && this._handler['canplay'].length);
                },
                _hasPoll: function() {
...
define('mq.view.desktopNotificationManager', ['jm'], function() {
    J.$package('mq.view.desktopNotificationManager', function(J) {
        ...
        function createNotificationWrapper(title, options) {
            var notification, notiWrapper;
            if (!isSupported || permissionLevel() !== PERMISSION_GRANTED) {
                return;
            }
            if (settings.detectPageVisibilify && !isDocumentHidden()) {
                return;
            }

            // arguments detection
            if ($T.isString(title) && (options && $T.isString(options.icon))) {
...
define('mq.view.desktopNotification', ['./mq.view.desktopNotificationManager', './mq.presenter.chat'], function() {
    J.$package("mq.view.desktopNotification", function(J) {
        ...
        this.onAllMessageReceived = function(data, notNotify) {
            if (notNotify || !$DN.isSupported || $DN.permissionLevel() !== $DN.PERMISSION_GRANTED) {
                return;
            }
...
define('tmpl!../tmpl/tmpl_notify_setting.html', [], function() {
    return function(obj) {
        ...
        with(obj || {}) {
            __p += '\r\n<div class="group">\r\n    <div class="row clearfix">\r\n        <span class="label">' + ((__t = ($M('voice'))) == null ? '' : __t) + '</span>\r\n        <label class="switch switch-white" cmd="clickVoiceSetting">\r\n            <input id="enableVoiceBtn" type="checkbox" ' + ((__t = (data.enableVoice ? "checked" : "")) == null ? '' : __t) + '>\r\n            <span/>\r\n        </label>\r\n    </div>\r\n    <div class="row clearfix">\r\n        <span class="label">' + ((__t = ($M('notification'))) == null ? '' : __t) + '</span>\r\n        <label class="switch switch-white" cmd="clickNotificationSetting">\r\n            <input id="enableNotificationBtn" type="checkbox" ' + ((__t = (data.enableNotification ? "checked" : "")) == null ? '' : __t) + '>\r\n            <span/>\r\n        </label>\r\n    </div>\r\n</div>\r\n\r\n<div class="group">\r\n    <div class="row">\r\n        <div class="clearfix">\r\n            <span class="label">' + ((__t = ($M('https_setting'))) == null ? '' : __t) + '</span>\r\n            <label class="switch switch-white" cmd="clickHttpsSetting">\r\n                <input id="enableHttpsBtn" disabled="disabled" type="checkbox" checked>\r\n                <span/>\r\n            </label>\r\n        </div>\r\n        <div class="tips">' + ((__t = ($M('https_msg'))) == null ? '' : __t) + '</div>\r\n    </div>\r\n</div>\r\n';
            if (!J.platform.touchDevice) {
                __p += '\r\n<div class="group">\r\n    <div class="row">\r\n        <div class="clearfix">\r\n            <span class="long_label">' + ((__t = ($M('send_msg_way'))) == null ? '' : __t) + '</span>\r\n            <label class="switch switch-white" cmd="clickCtrlEnterSetting">\r\n                <input id="enableCtrlEnterBtn" type="checkbox" ' + ((__t = (data.enableCtrlEnter ? "checked" : "")) == null ? '' : __t) + '>\r\n                <span/>\r\n            </label>\r\n        </div>\r\n    </div>\r\n</div>\r\n';
            }
            __p += '\r\n';
        }
        return __p;
...
define('mq.view.notifySetting', ['tmpl!../tmpl/tmpl_notify_setting.html', "./mq.i18n", "./mq.view.transitionmanager"], function(tmplNotifyBody) {
...
define('tmpl!../tmpl/tmpl_main_footer.html', [], function() {
    return function(obj) {
        ...
        with(obj || {}) {
            ...
            for (var i = 0, item; item = items[i]; i++) {
                __p += '\r\n        <li id="' + ((__t = (item.id)) == null ? '' : __t) + '" class="' + ((__t = (item.className)) == null ? '' : __t) + '" cmd="clickNav" param="' + ((__t = (item.id)) == null ? '' : __t) + '">\r\n            <a>\r\n                <div class="icon"></div>\r\n                <span>' + ((__t = (item.text)) == null ? '' : __t) + '</span>\r\n            </a>\r\n        </li>\r\n        ';
            }
...
define('mq.view.main', ['tmpl!../tmpl/tmpl_main_footer.html', "./mq.i18n", "./mq.view.transitionmanager"], function(tmplMainFooter) {
    J.$package("mq.view.main", function(J) {
        var packageContext = this;
        var MAX_BG_NUM = 28;
        var newBgImagePath = 'img/bg/';
        var newBgImageNum, localNewBg, localFlag;
...
;
define('mq.main', ['tmpl!../tmpl/tmpl_main_top.html', '../lib/mui/js/mui.tab', '../lib/mui/js/mui.textarea', '../lib/mui/js/mui.lazyload', '../lib/mui/js/mui.imagechange', '../lib/mui/js/mui.slide', '../lib/mui/js/mui.swipechange',

"./mq.i18n", "./mq.view.transitionmanager", "./mq.util",

"./mq.view.TitlePanel", "./mq.rpcservice",

"./mq.view.MemberList", "./mq.model.memberlist", "./mq.presenter.memberlist",

"./mq.model.chat", "./mq.view.chat", "./mq.presenter.chat",

"./mq.presenter.search", "./mq.view.search",

"./mq.presenter.profile", "./mq.view.profile",

"./mq.view.member", "./mq.presenter.member",

"./mq.model.record", "./mq.view.record", "./mq.presenter.record",

"./mq.view.session", "./mq.view.contact", "./mq.view.setting", "./mq.presenter.setting",

"./mq.presenter.pluginDisplayer", "./mq.view.plugin", "./mq.view.pluginDisplayer",

"./mq.view.audioNotification", "./mq.view.desktopNotificationManager", "./mq.view.desktopNotification", "./mq.presenter.notification",

"./mq.view.notifySetting", "./mq.presenter.notifySetting",

"./mq.view.main", "./mq.view.loginPanel", "./mq.main",
 ...
 * @module 入口模块
 */
require(['jm', 'iscroll', './mq.portal', './mq.main', './mq.report'], function(JM, iScroll) {
